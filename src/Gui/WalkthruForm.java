...
public class WalkthruForm extends com.codename1.ui.Form {
    ...
    public WalkthruForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        Image bla = resourceObjectInstance.getImage("produit.jpg");
        Image griffith = resourceObjectInstance.getImage("Appels.png");
        Image learn = resourceObjectInstance.getImage("forum.png");
        ...
        Container content1 = BoxLayout.encloseY(
                new Label("Consulter nos Produits ", "WelcomeTitle"),
        ...
        Container content2 = BoxLayout.encloseY(
                new Label("Nos Appelle d'offre ", "WelcomeTitle"),
                new Label(resourceObjectInstance.getImage("welcome-separator.png"), "WelcomeTitle"),
                new SpanLabel(line2, "WelcomeBody")
        );

        Container content3 = BoxLayout.encloseY(
                new Label("Nos Forum", "WelcomeTitle"),
                new Label(resourceObjectInstance.getImage("welcome-separator.png"), "WelcomeTitle"),
...
//-- DON'T EDIT ABOVE THIS LINE!!!
    ...
    public void onButton_1ActionEvent(com.codename1.ui.events.ActionEvent ev) throws IOException {
